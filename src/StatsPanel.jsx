...
export default function StatsPanel({ collisions, allCollisions, loading, onHighlightLocation, highlightGeoId, onExcludedChange, excludedGeoIds }) {
  ...
  if (loading) {
    return (
      <div style={{ display: "flex", alignItems: "center", justifyContent: "center", height: "100%", flexDirection: "column", gap: 12, color: "#6B7280" }}>
    ...
    return (
      <div style={{ display: "flex", alignItems: "center", justifyContent: "center", height: "100%", padding: 24 }}>
        <div style={{ textAlign: "center", color: "#6B7280" }}>
          <svg width="36" height="44" viewBox="0 0 36 44" fill="#6B7280" style={{ marginBottom: 14 }}><path d="M18 0C11 0 5 6 5 13c0 10 13 27 13 27s13-17 13-27C31 6 25 0 18 0zm0 18a5 5 0 110-10 5 5 0 010 10z"/></svg>
        ...
        {TABS.map(t => (
          <button key={t} onClick={() => setTab(t)} style={{
            ...
            {t === "Locations" && allLocations.length > 0 && (
              <span style={{ marginLeft: 5, background: accent, color: "#fff", borderRadius: 10, padding: "0 5px", fontSize: 10 }}>
                {allLocations.length}
              </span>
            )}
          </button>
      ...
      <div style={{ flex: 1, overflowY: "auto", paddingRight: 2 }}>
        {tab === "Stats" ? (
          <>
            ...
            <div style={{ fontSize: 10, color: "#6B7280", textAlign: "center", paddingBottom: 16, lineHeight: 1.7 }}>
